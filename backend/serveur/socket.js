...
exports.f = function(io, mysql, sql) {
  ...
  // cette fonction de callback s'exécute à chaque fois qu'un client émet l'événement "connection"
  io.on('connection', function (socket) {

    // lorsque le client effectue un socket.emit('bouton_client'), cette fonction s'exécute
